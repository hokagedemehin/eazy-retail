...
import { SubscriptionBankSvgComponent } from '@/assets/icons';
// import { EmptyListSvgComponent } from '@/assets/icons';

const Subscriptions = ({
  navigation,
}: Omit<ProfileHomeProps<'Subscriptions'>, 'route'>) => {
  // ******************* HIDE TABS *******************
          ...
          <View style={styles.summaryButtonsWrapper}>
            <View style={styles.summaryWrapper}>
              ...
              <View style={styles.tax}>
                ...
                <Text style={styles.taxAmount}>₦2,000</Text>
              </View>
              {/* )} */}
              <View style={styles.discount}>
                <Text style={styles.discountText}>
                  Number of staff (2k/staff)
                </Text>
                <Text style={styles.discountAmount}>₦4,000</Text>
              </View>
              <Divider style={{ marginBottom: 10 }} />
              <View style={styles.total}>
                <Text style={styles.totalText}>Total</Text>
                <Text style={styles.totalAmount}>₦6,000</Text>
              </View>
            </View>
          ...
          <View style={styles.actionSheetContentBox}>
            ...
            <View style={styles.actionSheetContent}>
              <Image
                ...
                source={{
                  uri: 'https://res.cloudinary.com/luvely/image/upload/v1687513454/Paystack-CeruleanBlue-LM_1_qkl5un.png',
                }}
              />
